...
A jQuery plugin for drag and drop form creation, formBuilder has [many options](https://formbuilder.online/docs/formBuilder/overview/) and is translatable. Typescript coming soon.
