...
;// ../src/js/dom.js
function dom_defineProperty(e, r, t) { return (r = dom_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function dom_toPropertyKey(t) { var i = dom_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function dom_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
const instanceDom = {};
...
class Dom {
  constructor(formID) {
    dom_defineProperty(this, "stage", void 0);
    dom_defineProperty(this, "controls", void 0);
    dom_defineProperty(this, "formActions", void 0);
    dom_defineProperty(this, "editorWrap", void 0);
...
// EXTERNAL MODULE: ../src/sass/form-render.scss
var form_render = __webpack_require__(700);
...
class FormRender {
  constructor(options = {}) {
    ...
    if (!(mi18n_min_default()).current) {
      mi18n_min_default().init(this.options.i18n);
    }
    ...
    if (typeof Element.prototype.appendFormFields !== 'function') {
      Element.prototype.appendFormFields = function (fields) {
        ...
        const renderedFormWrap = js_utils.markup('div', null, {
        ...
        fields.forEach(field => {
          ...
          if (rowGroup) {
            ...
            if (!rowGroupNode) {
              rowGroupNode = js_utils.markup('div', null, {
                id: rowID,
                className: 'row'
              });
  ...
  sanitizeField(field, instanceIndex) {
    ...
    sanitizedField.className = Array.isArray(field.className) ? js_utils.unique(field.className.join(' ').split(' ')).join(' ') : field.className || field.class || null;
    delete sanitizedField.class;
    if (field.values) {
      sanitizedField.values = field.values.map(option => js_utils.trimObj(option));
    }
    sanitizedField = js_utils.trimObj(sanitizedField);
  ...
  get userData() {
    ...
    this.instanceContainers.forEach(container => {
      const userDataMap = $('select, input, textarea', container).serializeArray().reduce((acc, {
        name,
        value
      }) => {
        name = name.replace(/\[\w*]/, '');
