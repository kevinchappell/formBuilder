...
exports.config = exports.defaultI18n = exports.defaultOptions = undefined;
  ...
  actionButtons: [{
    ...
    events: {
      click: function click(e) {
        return _helpers2.default.confirmRemoveAll(e);
      }
    }
  }, {
    label: 'viewJSON',
    ...
    events: {
      click: function click() {
        return _helpers2.default.showData();
      }
    }
  }, {
    id: 'save',
    ...
    events: {
      click: function click(e) {
        return config.opts.onSave(e, _helpers2.default.save());
      }
    }
  }],
...
},{"./helpers":128}],124:[function(require,module,exports){
"use strict";
...
(function ($) {
  ...
  var initI18N = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(i18nOpts) {
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _mi18n2.default.init(i18nOpts);
  ...
  var FormBuilder = function FormBuilder(opts, element) {
    ...
    _data2.default.formID = formBuilder.formID = frmbID;

    var subtypes = _helpers2.default.processSubtypes(opts.subtypes);

    var $sortableFields = $('<ul/>').attr('id', frmbID).addClass('frmb');

    _config.config.layout = _helpers2.default.editorLayout(opts.controlPosition);
    _dom2.default.stage = $sortableFields[0];
    ...
    frmbFields = _helpers2.default.orderFields(frmbFields);
    ...
    var cbUl = m('ul', null, { id: boxID, className: 'frmb-control' });
    _dom2.default.controls = cbUl;
    ...
    _utils2.default.forEach(frmbFields, function (i) {
      ...
      attrs.name = attrs.name || _utils2.default.nameAttr(field);
    ...
    if (opts.inputSets.length) {
      ...
      opts.inputSets.forEach(function (set, i) {
        set.name = set.name || _helpers2.default.makeClassName(set.label);
    ...
    $sortableFields.sortable({
      ...
      opacity: 0.9,
      revert: 150,
      beforeStop: _helpers2.default.beforeStop,
      start: _helpers2.default.startMoving,
      stop: _helpers2.default.stopMoving,
    ...
    $cbUL.sortable({
      ...
      update: function update(event, ui) {
        if (_helpers2.default.doCancel) {
          return false;
        }
        if (ui.item.parent()[0] === $sortableFields[0]) {
          processControl(ui.item);
          _helpers2.default.doCancel = true;
        } else {
          _helpers2.default.setFieldOrder($cbUL);
          _helpers2.default.doCancel = !opts.sortableControls;
        }
      }
    });
    ...
    var processControl = function processControl(control) {
      if (control[0].classList.contains('input-set-control')) {
        ...
        inputSets.forEach(function (field) {
          ...
          if (_helpers2.default.stopIndex || _helpers2.default.stopIndex === 0) {
            _helpers2.default.stopIndex++;
          }
        });
      } else {
    ...
    var $formWrap = $('<div/>', {
      id: frmbID + '-form-wrap',
      'class': 'form-wrap form-builder' + _helpers2.default.mobileClass()
    });

    var $stageWrap = $('<div/>', {
      id: frmbID + '-stage-wrap',
      'class': 'stage-wrap ' + _config.config.layout.stage
    });

    var cbWrap = $('<div/>', {
      id: frmbID + '-cb-wrap',
      'class': 'cb-wrap ' + _config.config.layout.controls
    }).append($cbUL[0]);

    if (opts.showActionButtons) {
      var buttons = opts.actionButtons.map(function (btnData) {
        if (btnData.id && opts.disabledActionButtons.indexOf(btnData.id) === -1) {
          return _helpers2.default.processActionButtons(btnData);
        }
      });
    ...
    var saveAndUpdate = _helpers2.default.debounce(function (evt) {
      if (evt) {
        ...
        _helpers2.default.updatePreview($field);
        _helpers2.default.save();
      }
    });
    ...
    $('li', $cbUL).click(function (evt) {
      ...
      _helpers2.default.stopIndex = undefined;
    ...
    var nonEditableFields = function nonEditableFields() {
      ...
      _helpers2.default.disabledTT.init();
    };
    ...
    var loadFields = function loadFields(formData) {
      formData = _helpers2.default.getData(formData);
    ...
    var fieldOptions = function fieldOptions(values) {
      ...
      if (!values.values || !values.values.length) {
        ...
        var firstOption = values.values[0];
      ...
      _utils2.default.forEach(values.values, function (i) {
    ...
    var advFields = function advFields(values) {
      var advFields = [];
      var key = void 0;
      var valueField = !_utils2.default.inArray(values.type, ['header', 'paragraph', 'file'].concat(_dom2.default.optionFields));
    ...
    var appendNewField = function appendNewField(values) {
      ...
      if (typeof _helpers2.default.stopIndex !== 'undefined') {
        $('> li', $sortableFields).eq(_helpers2.default.stopIndex).before($li);
      } else {
        $sortableFields.append($li);
      }

      $('.sortable-options', $li).sortable({ update: function update() {
          return _helpers2.default.updatePreview($li);
        } });

      _helpers2.default.updatePreview($li);
      ...
      if (opts.editOnAdd && isNew) {
        _helpers2.default.closeAllEdit();
        _helpers2.default.toggleEdit(lastID, false);
      }

      lastID = _helpers2.default.incrementId(lastID);
    };
    ...
    var selectFieldOptions = function selectFieldOptions(name, optionData, multipleSelect) {
      ...
      for (var i = optionDataOrder.length - 1; i >= 0; i--) {
        ...
        if (optionData.hasOwnProperty(prop)) {
          ...
          optionInputs.push(_utils2.default.markup('input', null, attrs));
        }
      }
    ...
    $sortableFields.on('click touchstart', '.toggle-form, .close-field', function (e) {
      ...
      if (e.handled !== true) {
        ...
        _helpers2.default.toggleEdit(targetID);
        e.handled = true;
      } else {
        return false;
      }
    ...
    $sortableFields.on('keyup change', '[name="label"]', function (e) {
      ...
      $('.field-label', $(e.target).closest('li')).html(_utils2.default.parsedHtml(value));
    });
    ...
    $sortableFields.on('blur', 'input.fld-name', function (e) {
      e.target.value = _helpers2.default.safename(e.target.value);
      if (e.target.value === '') {
    ...
    $sortableFields.on('blur', 'input.fld-maxlength', function (e) {
      e.target.value = _helpers2.default.forceNumber(e.target.value);
    });
    ...
    $sortableFields.on('click touchstart', '.icon-copy', function (e) {
      ...
      _helpers2.default.updatePreview($clone);
      _helpers2.default.save();
    });
    ...
    $sortableFields.on('click touchstart', '.delete-confirm', function (e) {
      ...
      if (opts.fieldRemoveWarn) {
        ...
        _helpers2.default.confirm([warnH3, warnMessage], function () {
          return _helpers2.default.removeField(deleteID);
        }, coords);
        $field.addClass('deleting');
      } else {
        _helpers2.default.removeField(deleteID);
      }
    });
    ...
    $sortableFields.on('click', '.style-wrap button', function (e) {
      ...
      _helpers2.default.updatePreview($btnStyle.closest('.form-field'));
      _helpers2.default.save();
    });
    ...
    if (opts.stickyControls.enable) {
      _helpers2.default.stickyControls($sortableFields);
    }
    ...
    formBuilder.actions = {
      clearFields: _helpers2.default.removeAllFields,
      showData: _helpers2.default.showData,
      save: _helpers2.default.save,
      addField: function addField(field, index) {
        _helpers2.default.stopIndex = _dom2.default.stage.children.length ? index : undefined;
        prepFieldVars(field);
        document.dispatchEvent(_events2.default.fieldAdded);
      },
      removeField: _helpers2.default.removeField,
      getData: function getData() {
        var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'js';

        var stage = _dom2.default.stage;
        var h = _helpers2.default;
        var data = {
          js: function js() {
      ...
      setData: function setData(formData) {
        _helpers2.default.removeAllFields(false);
        loadFields(formData);
      }
    };
    ...
    formBuilder.formData = _data2.default.formData;
  ...
  $.fn.formBuilder = function (options) {
    ...
    var _$$extend = $.extend({}, _config.defaultOptions, options, true),
        i18nOptions = _$$extend.i18nOptions,
        opts = (0, _objectWithoutProperties3.default)(_$$extend, ['i18nOptions']);

    _config.config.opts = opts;
    var i18nOpts = $.extend({}, _config.defaultI18n, i18nOptions, true);
...
},{"./config":123,"./data":124,"./dom":125,"./events":126,"./helpers":128,"./kc-toggle.js":129,"./polyfills.js":130,"./utils":131,"babel-runtime/core-js/object/assign":5,"babel-runtime/core-js/object/keys":6,"babel-runtime/helpers/asyncToGenerator":10,"babel-runtime/helpers/objectWithoutProperties":11,"babel-runtime/helpers/toConsumableArray":13,"babel-runtime/regenerator":15,"mi18n":119}],128:[function(require,module,exports){
'use strict';
 ...
 */
helpers.makeClassName = function (str) {
  str = str.replace(/[^\w\s\-]/gi, '');
  return _utils2.default.hyphenCase(str);
};
...
helpers.beforeStop = function (event, ui) {
  var opts = _config.config.opts;
  var form = document.getElementById(_data3.default.formID);
  ...
  helpers.doCancel = cancelArray.some(function (elem) {
    return elem === true;
  });
};
  ...
  if (form.childNodes.length !== 0) {
    ...
    _utils2.default.forEach(form.childNodes, function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(index, field) {
        var $field, fieldData, roleVals, id, instance, _data, _id, editor, match, multipleField;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!$field.hasClass('disabled-field')) {
                  fieldData = helpers.getTypes($field);
                  ...
                  if (fieldData.subtype) {
                    if (fieldData.subtype === 'quill') {
                      ...
                      if (window.fbEditors.quill[id]) {
                        ...
                        _data = instance.getContents();

                        fieldData.value = window.JSON.stringify(_data.ops);
                      }
...
helpers.jsonSave = function (form) {
  return window.JSON.stringify(helpers.prepData(form), null, '\t');
};

helpers.getData = function (formData) {
  formData = formData || _config.config.opts.formData;
  ...
  _data3.default.formData = setData[_config.config.opts.dataType](formData) || [];

  return _data3.default.formData;
};
...
helpers.save = function () {
  ...
  _data3.default.formData = doSave[_config.config.opts.dataType](_dom2.default.stage);
...
helpers.setAttrVals = function (field, fieldData) {
...
helpers.disabledTT = {
  ...
  init: function init() {
    _dom2.default.stage.querySelectorAll('.disabled-field').forEach(function (field) {
      ...
      if (title) {
        ...
        field.addEventListener('mousemove', function (e) {
          helpers.disabledTT.move(e, { tt: tt, field: field });
        });
      }
    });
  }
...
helpers.classNames = function (field, previewData) {
  var i = void 0;
 ...
 * @return {Object}            dom
 */
helpers.dialog = function (content) {
...
helpers.confirmRemoveAll = function (e) {
  var i18n = _mi18n2.default.current;
  var fields = $('li.form-field', _dom2.default.stage);
  var buttonPosition = e.target.getBoundingClientRect();
  var bodyRect = document.body.getBoundingClientRect();
  var coords = {
    pageX: buttonPosition.left + buttonPosition.width / 2,
 ...
 * @return {void}
 */
helpers.removeAllFields = function () {
  var animate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

  var i18n = _mi18n2.default.current;
  var opts = _config.config.opts;
  var form = _dom2.default.stage;
 ...
 * @param  {Object} stage
 */
helpers.closeAllEdit = function () {
  var fields = $('> li.editing', _dom2.default.stage);
  var toggleBtns = $('.toggle-form', _dom2.default.stage);
 ...
 */
helpers.toggleEdit = function (fieldId) {
...
helpers.stickyControls = function () {
  var $cbWrap = $(_dom2.default.controls).parent();
  var $stageWrap = $(_dom2.default.stage).parent();
  var cbWidth = $cbWrap.width();
  var cbPosition = _dom2.default.controls.getBoundingClientRect();
  ...
  $(window).scroll(function (evt) {
    ...
    if (scrollTop > $stageWrap.offset().top) {
      ...
      _dom2.default.controls.parentElement.removeAttribute('style');
    }
  });
};
 ...
 */
helpers.showData = function () {
  var formData = _utils2.default.escapeHtml(_data3.default.formData);
 ...
 */
helpers.removeField = function (fieldID) {
...
helpers.processActionButtons = function (buttonData) {
  ...
  if (!attrs.id) {
    attrs.id = _data3.default.formID + '-action-' + Math.round(Math.random() * 1000);
  } else {
    attrs.id = _data3.default.formID + '-' + attrs.id + '-action';
  }
...
helpers.processSubtypes = function (subtypeOpts) {
  ...
  _dom2.default.subtypes = _utils2.default.merge(_dom2.default.defaultSubtypes, subtypeOpts);
...
},{"./config":123,"./data":124,"./dom":125,"./events":126,"./utils":131,"babel-runtime/core-js/object/assign":5,"babel-runtime/core-js/object/keys":6,"babel-runtime/helpers/asyncToGenerator":10,"babel-runtime/helpers/objectWithoutProperties":11,"babel-runtime/regenerator":15,"mi18n":119}],129:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/core-js/object/assign":5}],131:[function(require,module,exports){
'use strict';
