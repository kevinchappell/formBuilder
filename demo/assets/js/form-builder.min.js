                ...
                return A.prototype.startMoving = function(A, e) {
                    ...
                    return 0 !== A.childNodes.length && s.default.forEach(A.childNodes, function(A, o) {
                        ...
                        if (!i.hasClass("disabled-field")) {
                            ...
                            n.type.match(t.optionFieldsRegEx) && (n.values = r.fieldOptionData(i)), e.push(n)
                        }
                    }), e
        ...
        var E = t(35),
            ...
            Q = function A(e, t) {
                ...
                e.inputSets.length && e.inputSets.forEach(function(A, e) {
                    A.name = A.name || f.default.makeClassName(A.label);
                    var t = D("li", A.label, {
                ...
                var _ = function() {
                    ...
                    AA = function(A) {
                        ...
                        a && (t.style = a[1]), uA(t, e), e && document.dispatchEvent(d.default.fieldAdded), Z.classList.remove("empty")
                    },
                    eA = function(A) {
                ...
                return document.dispatchEvent(d.default.loaded), g.actions = {
                    ...
                    addField: function(A, e) {
                        C.stopIndex = h.formData.length ? e : void 0, AA(A), document.dispatchEvent(d.default.fieldAdded)
                    },
                ...
                return n(e, A), e.register = function() {
                    ...
                    for (var o = t, i = Array.isArray(o), n = 0, o = i ? o : o[Symbol.iterator]();;) {
                        ...
                        if (!A[c]) {
                            ...
                            // change for custom element render
                            var dataType = l.datatype ? l.datatype : c + "-" + _Mathfloor(9e3 * Math.random() + 1e3);
                            f = dataType, e.customRegister[f] = $.extend(l, {
                                type: c,
                                class: g
                            })
                            // change for custom element render
