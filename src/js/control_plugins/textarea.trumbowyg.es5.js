...
window.fbControls.push(function (controlClass, allControlClasses) {
  ...
  var controlTrumbowyg = function (_controlTextarea) {
    _inherits(controlTrumbowyg, _controlTextarea);

    function controlTrumbowyg() {
      _classCallCheck(this, controlTrumbowyg);

      return _possibleConstructorReturn(this, (controlTrumbowyg.__proto__ || Object.getPrototypeOf(controlTrumbowyg)).apply(this, arguments));
    }

    _createClass(controlTrumbowyg, [{
      key: 'configure',
      ...
      value: function build() {
        var attrs = Object.assign(this.config);
      ...
      value: function onRender(evt) {
        ...
        var editor = window.fbEditors.trumbowyg[this.id] = $(this.field);
        ...
        editor.trumbowyg({
          ...
          _this2.input.value = editor.trumbowyg('html');
        }).trumbowyg('html', value);
      }
    }]);

    return controlTrumbowyg;
  }(controlTextarea);
