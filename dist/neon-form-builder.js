...
window.neon.Builder = function ($) {
  ...
  var Builder = function Builder(options, element) {
    var defaults = {
    ...
    this.opts = Object.assign({}, defaults, options), this.frmbID = 'frmb-' + $('ul[id^=frmb-]').length++;
  };
...
window.neon.VerticalFormBuilder = function ($) {
  var VerticalFormBuilder = fbUtils.extend(Builder, {});
...
window.neon.HorizontalFormBuilder = function ($) {
  var HorizontalFormBuilder = fbUtils.extend(Builder, {});
  return HorizontalFormBuilder;
}(jQuery);
'use strict';
